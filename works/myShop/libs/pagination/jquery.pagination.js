	...
	return this.each(function() {
		...
		function drawLinks() {
			...
			var appendItem = function(page_id, appendopts){
				...
				panel.append(lnk);
				//*******************************
				if(appendopts.text==opts.last_text){
						
						var sele="";
						for(var sel=1;sel<np+1;sel++){
							if((current_page+1)==sel){
								sele = sele + "<option selected='selected'>"+  sel +"</option>";
							}else{
								sele = sele + "<option>"+  sel +"</option>";
							}
						}
						var lnk=$("<select>"+sele+"</select>").bind("change",function (){
							var evt=$(this);
