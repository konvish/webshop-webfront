...
(function($) {
	$.fn.jqueryzoom = function(options) {
		...
		$(this).hover(function() {
			...
			var imageWidth = settings.smallWidth;
			var imageHeight = settings.smallHeight;
			...
			$(document.body).mousemove(function(e) {
				...
				var bigwidth = settings.bigpicWidth;
				var bigheight = settings.bigpicHeight;
				var scaley = 'x';
				var scalex = 'y';
				if (isNaN(scalex) | isNaN(scaley)) {
					var scalex = (bigwidth / imageWidth);
					var scaley = (bigheight / imageHeight);
					$("div.jqZoomPup").width((settings.xzoom) / (scalex * 1));//viewX = xzoom / bigwidth * smallWidth
